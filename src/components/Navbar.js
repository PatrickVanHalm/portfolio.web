    ...
    <div className='fixed z-50 bg-dark-500 w-full top-0 left-0 px-8 py-4 lg:px-20 xl:px-36'>
        <div className="flex justify-between items-center text-white">
            <ul className="hidden md:flex">
                ...
                <li className="p-4"><a href="https://portfolio.drieam.app/s/GuxUr36X/KpBY1xWbrhPmWmuUecf4EW15" className="hover:underline" target="_blank" rel="noreferrer">Student Portfolio</a></li>
            </ul>
